...
It has been built using [faust2webaudio](https://github.com/grame-cncm/faust2webaudio). The webapp has been created using `faust2webaudiowasm` (see [Faust Tools](https://faustdoc.grame.fr/manual/tools/) for details).
