...
Scale Builder is a tool to build microtonally accurate scales for Ragas in Indian Classical music.

Use the common parameters below to set the `Sa` to any pitch you prefer.

<CommonPitch />

For an introduction to Scale Builder and a quick user guide, click `Show`.
