...
<ScalePlayer title='Demo 5. Shadaj Gram - Achal Veena' noteSpec={notesShadajGramR0} scale={scaleShadajGram} />
...
<ScalePlayer title='Test 22' noteSpec={noteSpec} scale={scaleSamaGana} />