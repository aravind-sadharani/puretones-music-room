...
Listen to Demo 5 below to familiarize yourself with the Achal Veena scale. This is nothing but the Shadaj Gram scale in Demo 4, but depicted a bit differently.
...
<ScalePlayer title='Demo 5. Shadaj Gram - Achal Veena' noteSpec={notesShadajGramAchal} scale={scaleShadajGram} />
