...
export const kalyaniMotif = `Ni' Re Sa 2 Re Ma Ga Pa Ma Ni 2 Dha Pa Ma Dha Ni SA 2
...
export const hamsadhwaniMotif = `Ni' Re Ga Re Sa Re Ga Pa Ni 2 Pa Ni SA 2
...
export const hindolMotif = `Sa Ni' Dha' Sa Ga Ma Dha Ma Dha SA 2
