---
title: "Tanpura - A Prism for Harmonics"
date: 2021-09-03
category: 'Tuning Systems'
tags: [ 'Tanpura', 'Drone', 'Harmonics', 'Overtones', 'Prism Effect']
---
...
(Picture courtesy of <a target="_blank" rel="nofollow noreferrer" href="https://www.flickr.com/photos/91676597@N07/8325869555">Alex Lenovski</a> used under <a target="_blank" rel="nofollow noreferrer" href="https://creativecommons.org/licenses/by/2.0/">CC BY 2.0</a>, Labels by Aravind Iyer)
</FigCaption>
...
Listen to this model of a Tanpura string which puts together all the aspects we discussed so far.
...
Recall the first 16 harmonics from Demo 2. Are you able to hear those harmonics in the sound of a single Tanpura string? You can try and listen to Demo 2 and Demo 5 one after the other, a few times. You should be able to feel how strongly in tune they are with one another.

## Summary

We covered different aspects of the sound of a Tanpura. We looked at it from the perspective of its construction and saw how each string of a Tanpura emits a dispersion of its constituent harmonics.

In the [next article](/learn/tanpuraworking-2/), we will look at it from a musical perspective and see how an appropriately tuned Tanpura can support a desired Raga or musical scale.