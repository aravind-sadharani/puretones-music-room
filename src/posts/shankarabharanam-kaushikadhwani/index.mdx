...
Let us start by examining some common phrases in Raga Kalyani. Here are a few fragments of phrases which are used to construct musical phrases in Raga Shankrabharanam.
...
* For the phrase `Ni' Re Ga ma Ga Pa` if `(Ga,Pa)` and `(Ni',Re)` are identical intervals, it brings symmetry to the phrase.

* It is important to note that here Ni does not have a direct consonant relationship with any of the other notes, and therefore must be handled with care. It is advisable to pair Ni with Re or use it in a phrase where there are other consonant pairs, for example, Ni Dha Pa Dha ma Ga (here we use the consonance of `(ma,Dha)`, and Ga as the *Nyasa* since its an *Antara Gandhara* interval).
...
export const shankarabharanamMotif = `Ni' Re Sa Ga Re Ga ma Ga Pa 2 Dha ma Ga ma Pa Dha Ni Dha SA 2
SA Ni Dha Pa Dha ma Ga Pa ma Ga Re Ni' Sa 2`
