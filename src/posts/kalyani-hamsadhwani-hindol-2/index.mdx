...
Note that some musicians and musicologists classify Raga Hamsadhwani under Raga Shankarabharanam. The scale of Raga Shankarabharanam is `Sa Re Ga ma Pa Dha Ni`. Raga Hamsadhwani can be derived by dropping `ma` and `Dha`.
