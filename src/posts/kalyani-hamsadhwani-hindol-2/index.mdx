...
Note that some musicians/musicologists classify Raga Hamsadhwani under Raga Shankarabharanam. The scale of Shankarabharanam is `Sa Re Ga ma Pa Dha Ni`. Hamsadhwani can be derived by dropping `ma` and `Dha`.
...
Raga Hindol is widely accepted to be related to Raga Kalyani. Indeed, it can be arrived at by dropping Re and Pa from Kalyani. Raga Hindol uses the symmetry `(Ma,Dha) = (Dha,SA)` and `(Sa,Ga)` = *Antara Gandhara* interval. Again, if you observe closely, you can see that these relationships are already present in Raga Kalyani.
