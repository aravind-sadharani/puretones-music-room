...
<ScalePlayer title='Scale of Raga Todi' noteSpec={noteSpecTodi} scale={standardScale} />
...
<MotifPlayer title='Mishra Gamakas' motif={allGamakas} scale={standardScale} />
...
<MotifPlayer title='Sphuritam Gamaka 1' motif={sphuritamGamaka1} scale={standardScale} />
...
<MotifPlayer title='Sphuritam Gamaka 2' motif={sphuritamGamaka2} scale={standardScale} />
