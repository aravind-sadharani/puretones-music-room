...
tags: [ 'Sama Gana', 'Shadaj Gram', '22 Shrutis', '12 Note Scale', 'Adhara Shadaj', 'Tanpura', 'Harp Veena', 'Fretted Veena' ]
---
...
Under the influence of the Sama Gana scale, it is likely that early musical works retained the scale and its intervals and worked with them. We present a composition in Demo 2 in [Indian Musical Scales](/learn/musicalscales) which is an artistic recollection of such a proto-typical work of music.
...
With the invention of new instruments with the capability to slide or modulate notes with frets, the musical thinking must have definitely evolved. We present a couple of compositions labelled Demo 2 and Demo 3 in in [Indian Musical Scales](/learn/musicalscales) which are an artistic recollection of how music evolved and became more sophisticated in this period.
